  ...
  return (
    <div className="flex gap-x-40">
      <div className="">
        ...
        <button className="py-3 px-8 my-4 text-neutral-50 bg-gradient-to-r from-pink-500 via-pink-500 to-pink-600 font-montserrat text-xs rounded hover:scale-105 ease-in-out duration-300">
          Download Resume
        </button>
        ...
        <ul className="space-x-4 justify-start flex">
          <li>
            <a href="https://www.linkedin.com/in/JoshuaOwDev" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faLinkedin} className="h-8 w-8 text-cyan-500 hover:text-cyan-600" />
            </a>
          </li>
          <li>
            <a href="https://www.github.com//joshuaow91" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faGithubSquare} className="h-8 w-8 text-cyan-500 hover:text-cyan-600" />
            </a>
          </li>
          <li>
            <a href="https://www.twitter.com/JoshuaOwDev" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faTwitterSquare} className="h-8 w-8 text-cyan-500 hover:text-cyan-600" />
            </a>
          </li>
          <li>
            <a href="mailto:joshuaow@gmail.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faSquareEnvelope} className="h-8 w-8 text-cyan-500 hover:text-cyan-600" />
            </a>
          </li>
        </ul>
      </div>
