  ...
  return (
    <div className='flex flex-col-reverse md:flex-row gap-4 items-center m-4 mt-20 md:mt-0'>
      ...
      <div className="flex flex-col items-center md:items-start">
        ...
        <a href={resumeFile} download="resume.pdf" className='px-4 py-3 mt-6 text-teal-950 bg-teal-500 rounded-lg font-light text-sm tracking-wide hover:scale-110 ease-in-out duration-300 dark:bg-teal-800 dark:text-white text-center'>
            Download Resume
        </a>
      </div>
    </div>
