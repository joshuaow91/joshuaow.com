...
import bgImage from './assets/parallax.svg'
  ...
  const Skillsets = () => {
    ...
    return (
        <>
        <div className="relative isolate overflow-hidden bg-teal-500 dark:bg-blacker h-96  px-5 md:px-10  font-montserrat mt-28 md:mt-0"
          style={{
        ...
        <div className="mx-auto max-w-7xl px-2 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 mt-20 md:mt-20">
            <h2 className="text-4xl font-bold tracking-tight text-center md:text-left text-teal-800 dark:text-white sm:text-4xl uppercase">My Skillsets</h2>
          </div>
