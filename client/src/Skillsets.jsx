...
import bgImage from './assets/parallax.svg'
  ...
  const Skillsets = () => {
    ...
    return (
        <>
        <div className="relative isolate overflow-hidden bg-teal-600 dark:bg-blacker h-96  px-5 md:px-10  font-montserrat mt-28 md:mt-0"
          style={{
        ...
        <div className="mx-auto max-w-7xl px-2 lg:px-8">
          <div className="mx-auto max-full lg:mx-0 mt-20 md:mt-10 flex justify-center">
            <h2 className="text-6xl font-bold tracking-tight text-center md:text-left text-teal-800 dark:text-white uppercase">My Skillsets</h2>
          </div>
          <div className="mx-auto mt-8 max-w-2xl lg:mx-0 lg:max-w-none">
            <dl className="grid grid-cols-3 gap-4 sm:mt-10 sm:grid-cols-3 lg:grid-cols-6 place-items-center">
                ...
                <dt className="text-xl leading-7 text-teal-800 dark:text-zinc-600">{skill.name}</dt>
                ...
                <dt className="text-xl flex flex-col items-center mb-3 text-teal-800 dark:text-zinc-600"><img src={TwindLogo} className="w-16 h-16 " />Tailwind</dt>
