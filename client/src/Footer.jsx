    ...
    return (     
      <footer className="bg-white rounded-lg drop-shadow-md m-4 dark:bg-blacker">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span className="text-sm text-zinc-300 sm:text-center dark:text-gray-300">
        ...
        <ul className="flex flex-wrap items-center mt-3 sm:mt-0 space-x-2">
          <li>
            <a href="https://www.linkedin.com/in/JoshuaOwDev" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faLinkedin} className="h-6 w-6 text-zinc-300 hover:text-zinc-400" />
            </a>
          </li>
          <li>
            <a href="https://www.github.com//joshuaow91" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faGithubSquare} className="h-6 w-6 text-zinc-300 hover:text-zinc-400" />
            </a>
          </li>
          <li>
            <a href="https://www.twitter.com/JoshuaOwDev" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faTwitterSquare} className="h-6 w-6 text-zinc-300 hover:text-zinc-400" />
            </a>
          </li>
          <li>
            <a href="mailto:joshuaow@gmail.com" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faSquareEnvelope} className="h-6 w-6 text-zinc-300 hover:text-zinc-400" />
            </a>
          </li>
        </ul>
        </div>
