    ...
    return (
        <div className="grid grid-cols-1 m-4 lg:grid-cols-3 gap-3 font-montserrat">
            ...
            <div className="bg-indigo-50 dark:bg-darkBlack drop-shadow-lg shadow-black rounded-lg p-4 max-w-s flex items-center gap-4">
                <FontAwesomeIcon icon={faLaptopCode} className="text-6xl bg-indigo-500 rounded-full text-teal-300 p-6 h-18 w-16"/>
            ...
            <div className="bg-indigo-50 dark:bg-darkBlack drop-shadow-lg shadow-black rounded-lg p-4 max-w-s flex items-center gap-4">
                <FontAwesomeIcon icon={faPaperPlane} className="text-6xl bg-indigo-500 rounded-full text-teal-300 p-6 h-18 w-16"/>
                <p className="text-gray-600 dark:text-gray-300 text-sm flex flex-col">
            ...
            <div className="bg-indigo-50 dark:bg-darkBlack drop-shadow-lg shadow-black rounded-lg p-4 max-w-s flex items-center gap-4">
                <FontAwesomeIcon icon={faRocket} className="text-6xl bg-indigo-500 rounded-full text-teal-300 p-6 h-18 w-16"/>
                <p className="text-gray-600 dark:text-gray-300 text-sm flex flex-col">
