      ...
      <div className="relative isolate overflow-hidden bg-cyan-600 dark:bg-blacker py-24 px-10 sm:py-32 skew-container font-montserrat ">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 unskew-child">
          ...
          <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-md font-semibold leading-7 text-black sm:grid-cols-2 md:flex lg:gap-x-10">
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-5">
                ...
                <dd className="text-lg font-bold leading-9 tracking-tight text-white">
