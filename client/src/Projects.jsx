...
const Projects = () => {
  return (
    <>
      <h1 className="flex justify-center font-montserrat font-bold mb-16 text-6xl tracking-tight text-zinc-700 dark:text-white">
        PROJECTS
      </h1>

      <div className="relative border-l border-t border-gray-200 dark:border-darkBlack flex flex-col gap-20">
        <div className="mt-5 flex flex-col items-start px-10">
          <span className="absolute flex items-center justify-center w-7 h-7 bg-slate-200 text-zinc-700 rounded-full -left-3 -top-3 ring-8 ring-slate-100 dark:ring-gray-900 dark:bg-pink-500 dark:text-white">
      ...
      <div className="flex flex-col md:flex-row justify-evenly items-center">
        <div className="flex flex-col w-1/3 p-4 bg-white rounded-lg drop-shadow-lg translate-x-10">
          ...
          <p className="mb-4 text-md font-light text-zinc-600 dark:text-gray-400 md:justify-center flex p-4 indent-3">
